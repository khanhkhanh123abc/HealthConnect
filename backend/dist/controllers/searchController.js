    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _searchService["default"].quickSearch(req.query.q);
        case 1:
          result = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          _logger["default"].error('[Search/quick] error:', _t.message);
...
var fullSearch = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _searchService["default"].search(req.query);
        case 1:
          result = _context2.v;
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          _logger["default"].error('[Search/full] error:', _t2.message);
  ...
  return function fullSearch(_x3, _x4) {
